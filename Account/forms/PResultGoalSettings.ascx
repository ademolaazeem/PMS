<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PResultGoalSettings.ascx.cs" Inherits="Account_forms_PResultGoalSettings" %>
<style type="text/css">
...
<%--<asp:BoundField DataField="KPI_TYPE" HeaderText="KPI Type" SortExpression="KPI_TYPE" />--%>
 ...
 <%-- <asp:BoundField DataField="TARGET" HeaderText="Target" SortExpression="TARGET" />--%>
        ...
        <ItemTemplate>
            <asp:TextBox ID="TARGET" runat="server" ValidationGroup="check"  Text='<%#Eval("TARGET") %>'></asp:TextBox>
           <asp:CompareValidator ID="CompareValidator1" runat="server" Operator="DataTypeCheck" Type="Double" ControlToValidate="TARGET" ErrorMessage="Value must be a number" />
           <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TARGET" Display="Dynamic" ErrorMessage="should not be blank !!"></asp:RequiredFieldValidator>
...
<%--<asp:BoundField DataField="KPI_TYPE" HeaderText="KPI Type" SortExpression="KPI_TYPE" />--%>
 ...
 <%-- <asp:BoundField DataField="TARGET" HeaderText="Target" SortExpression="TARGET" />--%>
        ...
        <ItemTemplate>
            <asp:TextBox ID="TARGET" runat="server" ValidationGroup="check" Text='<%#Eval("TARGET") %>'></asp:TextBox>
           <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TARGET"
