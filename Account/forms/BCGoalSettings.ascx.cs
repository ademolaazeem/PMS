...
public partial class Account_forms_BCGoalSettings : System.Web.UI.UserControl
{
    decimal grdTotal = 0;
    ...
    protected void btnSendToSupervisor_Click(object sender, EventArgs e)
    {
        ...
        holderSign = Session["holderSign"].ToString();
        ...
        if (emptyTextbox)
        {
            lblStatusSub.Text = "Please fill every empty necessary information";
            lblStatusSub.ForeColor = System.Drawing.Color.Red;
        }
        else
        {
            ...
            if (usr == "10" || usr == "20")
            {
                int retLog = crudsbLL.saveAuditLog(username, Request.UserHostAddress, "Goal Settings Mgmt: User " + username + " successfully updated his/her behavioural competencies for Goal Settings", "Update");
    ...
    protected void btnShowSubPRGoalSettings_Click(object sender, EventArgs e)
    {
       ...
       //string rstLoggedin = crudsbLL.getPhaseOneContent(username.Trim().ToLower());
       //if (rstLoggedin != string.Empty)
       //{
       //    string[] sepLoggedIn = rstLoggedin.Split('_');
       //    employeeNo = sepLoggedIn[3];
