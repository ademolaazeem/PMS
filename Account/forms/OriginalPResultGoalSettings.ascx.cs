...
public partial class Account_forms_OriginalPResultGoalSettings : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //////////////////////////////////Pretest/////////////////////////////////////////////
            ...
            try
            {
                ...
                else
                {
                    ...
                    lblStatus.Text = "User record not found, this user does not exist";// +rst.ToString();
        ...
        int retLog = crudsbLL.saveAuditLog(username, Request.UserHostAddress, "Goal Settings: User " + username + " successfully views actual Performance result page for Goal Settings Interface", "Create");
         ...
         bool emptyTextbox = false;
            if (GrdViewFinancial.Rows.Count > 0)
            {
                foreach (GridViewRow row in GrdViewFinancial.Rows)
                {
                    ...
                    TextBox txt = row.FindControl("TARGET") as TextBox;
