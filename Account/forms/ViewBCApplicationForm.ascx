<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ViewBCApplicationForm.ascx.cs" Inherits="Account_forms_ViewBCApplicationForm" %>
...
<script type = "text/javascript">
            function PrintPanel() {
                var panel = document.getElementById("<%=PnlAll.ClientID %>");
                var printWindow = window.open('', '', 'height=800,width=2000');
                printWindow.document.write('<html><head><title>View Performance Result For Appraisal Form Section</title>');
                ...
                <table align="left" cellpadding="5" cellspacing="5" style="width: 658px">
                    ...
                    <tr>
                        ...
                        <td>
                            4.3%</td>
                        <td>
                            <asp:Label ID="lblIndInno" runat="server" Text="0.0"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="style124">
                        ...
                        <td>
                            4.3%</td>
                        <td>
                            <asp:Label ID="lblIndLead" runat="server" Text="0.0"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="style124">
                        ...
                        <td>
                            4.3%</td>
                        <td>
                            <asp:Label ID="lblIndPEffect" runat="server" Text="0.0"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="style88">
                            <asp:TextBox ID="TxtProfJHolder" runat="server" TextMode="MultiLine" 
                                Width="149px" ReadOnly="True"></asp:TextBox>
                        </td>
