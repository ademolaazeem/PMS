<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ViewPResultApplicationForm.ascx.cs" Inherits="Account_forms_ViewPResultApplicationForm" %>
        ...
        <td class="style93">
           ...
           <asp:GridView ID="GrdViewKPI" runat="server" 
             ...
             <Columns>
                             ...
                             <ItemTemplate>
                                <asp:label id="INDIVIDUAL_PERFORMANCE_SCORE1" Text= '<%# Eval("INDIVIDUAL_PERFORMANCE_SCORE")%>' runat="server"/> 
                             
                             <%--<%# Eval("INDIVIDUAL_PERFORMANCE_SCORE").ToString()+"%"%>--%>
                             </ItemTemplate>
                                <FooterTemplate>
 ...
 <asp:BoundField DataField="SCORE" HeaderText="Score" SortExpression="SCORE" />
            ...
            <tr>
                <td class="style92">
                    ...
                    Height="49px" TextMode="MultiLine" Width="492px" style="text-align: left" 
...
<table>
 ...
 <asp:BoundField DataField="SCORE" HeaderText="Score" SortExpression="SCORE" />
        ...
        &nbsp;<asp:TextBox ID="TxtCustomerComments" runat="server" BorderStyle="Solid" 
                Height="49px" TextMode="MultiLine" Width="492px" style="text-align: left" ReadOnly="True"></asp:TextBox></td></tr>
                        </table>
