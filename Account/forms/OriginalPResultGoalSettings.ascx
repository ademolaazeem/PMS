<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OriginalPResultGoalSettings.ascx.cs" Inherits="Account_forms_OriginalPResultGoalSettings" %>
...
<%--<asp:BoundField DataField="KPI_TYPE" HeaderText="KPI Type" SortExpression="KPI_TYPE" />--%>
 ...
 <%-- <asp:BoundField DataField="TARGET" HeaderText="Target" SortExpression="TARGET" />--%>
        ...
        <ItemTemplate>
            ...
            <%--<asp:TextBox ID="TextBox1" runat="server" ValidationGroup="check"  Text='<%#Eval("TARGET") %>'></asp:TextBox>
